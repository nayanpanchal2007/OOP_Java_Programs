 ...
 * ● The method checkEligibility(int age) checks if a person is eligible to
 * vote.
 * ● If age < 18, explicitly throw the predefined exception
 * IllegalArgumentException with the message "Age must be 18 or above to vote".
